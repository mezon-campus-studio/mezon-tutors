...
import { tutorProfilePhotoAtom, tutorProfileLastSavedAtAtom, markStepCompletedAtom } from "@mezon-tutors/app/store";
...
export default function PhotoPage() {
  ...
  useEffect(() => {
    ...
    if (!tutorProfilePhoto.photo?.uploadedUrl && avatarUrl) {
